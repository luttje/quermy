...
#[AsTool(
    ...
    . 'The row counts and sizes are ESTIMATES sourced from engine statistics — they can be '
    . 'significantly off and should never be reported to the user as exact figures. '
